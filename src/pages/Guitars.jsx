...
const Guitars = () => {
  ...
  const brands = [
    'Fender', 'Gibson', 'Taylor', 'Martin', 'Ibanez', 'Yamaha', 'PRS', 'Epiphone', 'Gretsch', 'Seagull', 'Jackson'
  ];
  ...
  useEffect(() => {
    ...
    setTimeout(() => {
      ...
      if (productIdParam) {
        const found = Guitar.find(p => String(p.id) === String(productIdParam));
        setFilteredProducts(found ? [found] : []);
      } else {
        setFilteredProducts(Guitar);
      }
      setLoading(false);
    }, 1000);
  }, []);
  ...
  const FiltersContent = () => (
    <>
      {/* Filter by type */}
      <div className="mb-8">
        <h3 className="text-lg font-bold text-gray-900 mb-4">Guitar type</h3>
          ...
          <AnimatedSection>
            <div className="text-center max-w-3xl mx-auto relative z-10">
              <h1 className="text-4xl md:text-6xl font-bold mb-6 text-white">
                Our <span className="text-[#6819ce]">Guitars</span>
              </h1>
              <p className="text-xl text-white mb-8">
                Discover our exceptional selection of guitars for every style and every level
              </p>
            </div>
          </AnimatedSection>
        </div>
          ...
          <div className="flex flex-col lg:flex-row gap-6 items-center justify-between">
            ...
            <div className="flex-1 w-full lg:max-w-md">
              <div className="relative">
                <input
                  type="text"
                  placeholder="Search for a guitar, a brand..."
                  value={searchTerm}
              ...
              <AnimatePresence mode="wait">
                {currentItems.length > 0 ? (
                  ...
                  >
                    ...
                    <h3 className="text-xl font-bold text-gray-900 mb-2">No guitar found</h3>
